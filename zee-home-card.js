...
class CasaLuna extends HTMLElement {
  ...
  _styles() {
    return `
      ...
      /* camera tiles */
      .pw-cams { display:grid; grid-template-columns:repeat(2,1fr); gap:12px; margin-bottom:14px; }
      .pw-cam { width:100%; min-width:0; aspect-ratio:16/10; background:rgba(0,0,0,.55); border:1px solid rgba(0,200,255,.3);
